...
\]
其中 \(S_1,S_2\) 都是非空闭凸集，并且 \(S_1\cap S_2=\varnothing\)。但
\[
...
\[
p^T x\ge \alpha \ge p^T y,\qquad \forall x\in S_1,\ \forall y\in S_2.
\]
...
若要得到严格分离
\[
p^T x>\alpha>p^T y,\qquad \forall x\in S_1,\ \forall y\in S_2,
\]
通常还需要附加条件，例如
\[
